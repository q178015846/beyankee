 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">连连买管理后台</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('/') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin') }}"><i class="fa fa-dashboard fa-fw"></i> 个人工作台</a>
                        </li>
                        <li {{ (Request::is('*charts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/charts') }}"><i class="fa fa-bar-chart-o fa-fw"></i> 商品管理</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('*tables') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/tables') }}"><i class="fa fa-table fa-fw"></i> 销售管理</a>
                        </li>
                        <li {{ (Request::is('*forms') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/forms') }}"><i class="fa fa-edit fa-fw"></i> 会员管理</a>
                        </li>
                        <li >
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> 工具<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> 报告<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
